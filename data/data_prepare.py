...
def convert_to(data_path, name):
    ...
    depth = DEPTH
    for ii in range(10):
        writer = tf.python_io.TFRecordWriter(name + str(ii) + '.tfrecords_edge2shoes')
...
if __name__ == '__main__':
    ...
    data_path = raw_input("Enter the original data location: ");
    name = raw_input("Where you want to save the new data: ");
